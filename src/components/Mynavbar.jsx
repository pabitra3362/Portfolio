...
function Mynavbar() {
    ...
    return (
        ...
        <div className='bg-blue-950 flex justify-center'>
            ...
            <nav className="bg-blue-950 h-20 hidden md:hidden lg:flex justify-between items-center px-3 lg:w-[60vw] mx-auto fixed top-0 bg-transparent backdrop-blur-sm ">
