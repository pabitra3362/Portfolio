...
const ParticlesComponent = (props) => {
    ...
    return (
        <div id="top" className="h-[100vh] relative lg:z-10 -z-10">
            <div className="text grid justify-center gap-5 md:gap-1 pt-20 items-center h-screen w-full lg:w-[60vw] mx-auto lg:pt-10">
                <div className="lg:w-[45%] lg:flex lg:flex-col text-center lg:text-start grid gap-4">
                ...
                <div className="image h-96 w-80 md:w-fit border border-white overflow-hidden rounded-full mx-auto bg-transparent backdrop-blur-sm">
